...
namespace TFE_FrontEndUI
{
	...
	bool toggleEnhancements()
	{
		if (enhanceGOBExists())
		{
			...
			bool useHdAssets = enhancements->enableHdTextures && enhancements->enableHdSprites && enhancements->enableHdHud && enhancements->enableHdCutscenes && enhancements->enableHdPda;
